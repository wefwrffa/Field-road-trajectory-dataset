...
## Dataset Information
All trajectory data were collected from the **China’s agricultural machinery operation big data system** (Wu et al., 2023), where trajectories were recorded by GNSS devices installed on agricultural machines operating in China. Each trajectory record consists of five fundamental attributes:
...
## Citation
This dataset is derived from raw trajectory data collected by the **China’s agricultural machinery operation big data system**. If you use this dataset in your research, please cite following:

**The original data source:**
   Wu, C., Li, D., Zhang, X., Pan, J., Quan, L., Yang, W., Ma, Q., Su, C., & Zhai, W. (2023). China’s agricultural machinery operation big data system. *Computers and Electronics in Agriculture*, 205, 107594.

## License
The raw trajectory data underlying this dataset originates from the China’s agricultural machinery operation big data system and is redistributed here under the terms of that platform's data usage agreement. The specific scripts and organization in this repository are licensed under the MIT License.
